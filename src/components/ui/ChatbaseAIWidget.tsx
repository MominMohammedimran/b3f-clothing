...
const ChatbaseAIWidget: React.FC = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-30 right-4 sm:right-8 w-[70vw] sm:w-[360px] h-[75vh] sm:h-[400px] z-40 shadow-lg rounded-lg overflow-hidden border border-gray-200 bg-white">
  <iframe
