...
const ChatbaseAIWidget: React.FC = () => {
  ...
  return (
    <>
     ...
     {isOpen && (
         <div
             className="fixed bottom-24 right-4 z-40 rounded-lg overflow-hidden border border-gray-200 bg-white shadow-lg
               w-[85vw] h-[60vh] md:w-[30px] md:h-[400px] lg:w-[420px] lg:h-[700px]"
             >
    <iframe
